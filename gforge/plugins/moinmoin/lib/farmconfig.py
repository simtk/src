...
class FarmConfig(multiconfig.DefaultConfig):
    ...
    actions_excluded = multiconfig.DefaultConfig.actions_excluded + ['SubscribeUser']
    mail_sendmail = u'/usr/sbin/sendmail -t -i'
    #mail_from = u"noreply<noreply@simtkalpha.stanford.edu>"
    mail_from = u"noreply<noreply@simtk.org>"
