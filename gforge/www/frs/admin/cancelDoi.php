...
/**
 * Project Admin: Cancel a DOI request.
 *
...
echo '<div><h3>' . $frsf->getName() . '</h3></div>';
	...
	<input type="hidden" name="func" value="cancel_doi" />
	<input type="hidden" name="package_id" value="'. $package_id .'" />
	<input type="hidden" name="release_id" value="'. $release_id .'" />
	<input type="hidden" name="file_id" value="'. $file_id .'" />
	<p>You are about to cancel the DOI request for this file from the release!</p>
