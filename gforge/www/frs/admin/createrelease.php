...
$valSubmit = getStringFromRequest('submit');
if ($valSubmit) {
...
?>
		<p/><input type="checkbox" name="copy_release" value="1" ?><strong>&nbsp;Copy file structure from most recent previous release</strong>
<?php
	}
?>
		<p><input type="submit" name="submit" value="Add This Release" class="btn-cta" /></p>
	</td>
</tr>
</table>
