...
if (count($arrMissingMailList) > 0 ||
	...
	foreach ($arrMissingMailList as $strMailList) {
		...
		$strMissing .= $strMailList . ":" . 
			' 		 "|/usr/lib/mailman/mail/mailman post ' . $strMailList . '"' . PHP_EOL;
		$strMissing .= $strMailList . "-admin:" . 
			' 		 "|/usr/lib/mailman/mail/mailman admin ' . $strMailList . '"' . PHP_EOL;
		$strMissing .= $strMailList . "-bounces:" . 
			' 		 "|/usr/lib/mailman/mail/mailman bounces ' . $strMailList . '"' . PHP_EOL;
		$strMissing .= $strMailList . "-confirm:" . 
			' 		 "|/usr/lib/mailman/mail/mailman confirm ' . $strMailList . '"' . PHP_EOL;
		$strMissing .= $strMailList . "-join:" . 
			' 		 "|/usr/lib/mailman/mail/mailman join ' . $strMailList . '"' . PHP_EOL;
		$strMissing .= $strMailList . "-leave:" . 
			' 		 "|/usr/lib/mailman/mail/mailman leave ' . $strMailList . '"' . PHP_EOL;
		$strMissing .= $strMailList . "-owner:" . 
			' 		 "|/usr/lib/mailman/mail/mailman owner ' . $strMailList . '"' . PHP_EOL;
		$strMissing .= $strMailList . "-request:" . 
			' 		 "|/usr/lib/mailman/mail/mailman request ' . $strMailList . '"' . PHP_EOL;
		$strMissing .= $strMailList . "-subscribe:" . 
			' 		 "|/usr/lib/mailman/mail/mailman subscribe ' . $strMailList . '"' . PHP_EOL;
		$strMissing .= $strMailList . "-unsubscribe:" . 
			' 		 "|/usr/lib/mailman/mail/mailman unsubscribe ' . $strMailList . '"' . PHP_EOL;
	}
