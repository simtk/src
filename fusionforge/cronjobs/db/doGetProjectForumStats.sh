...
BASE_FILENAME=/usr/share/gforge/cronjobs/db/getProjectForumStats
SUBJECT=`hostname`": forum stats"

psql -h${db_server} -U${db_user} -d${db_name_forum} -f ${BASE_FILENAME}.sql >| ${BASE_FILENAME}.txt
