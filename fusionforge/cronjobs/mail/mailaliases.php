...
// copy aliases file
$date = date("Ymd-Hi");
$fromfile = "/etc/aliases";
$tofile = "/etc/aliases.bak/aliases".$date;
copy($fromfile,$tofile);

$purge_cmd = "cd /etc/aliases.bak;find . -name 'aliases*-*' -mtime +7 -delete";
passthru($purge_cmd, $failed);
if ($failed) {
	echo "Failed to purge /etc/aliases.bak";
}
