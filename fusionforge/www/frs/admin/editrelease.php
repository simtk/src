...
if ($submitAndNotify || $submitNoNotify) {
	...
	if ($exec_changes == true) {
		if (!$frsr->update($status_id, $release_name, $notes, $changes, $preformatted,
			$release_date, $release_desc, $emailChange)) {
			exit_error($frsr->getErrorMessage(),'frs');
		}
		else {
...
<tr>
	<td colspan="2" style="padding-top:15px;">
		<input type="submit" name="submitAndNotify" id="submitAndNotify" value="Update & Notify Followers" class="btn-cta" /> &nbsp;<input type="submit" name="submitNoNotify" id="submitNoNotify" value="Update & Do Not Notify Followers" class="btn-cta" />
	</td>
</tr>
