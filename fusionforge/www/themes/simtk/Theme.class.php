...
*/
		...
		echo 'Version 5.0.0. Website design by <a href="http://www.viewfarm.com/">Viewfarm</a>. Icons created by SimTK team using art by <a href="http://graphberry.com" title="GraphBerry">GraphBerry</a> from <a href="http://www.flaticon.com" title="Flaticon">www.flaticon.com</a> under a CC BY 3.0 license. Forked from FusionForge 6.0.5.';
                echo '</div>';
	...
	function getPageTitle($title_arr, $links_arr) {
		...
		if ($pageTitle == "Project Admin") {
			...
			case "/frs/admin":
				...
				if (strpos($theUri, "&study_id=") != false &&
					strpos($theUri, "obtainPackageDoi.php?") != false) {
			...
			case "/plugins/datashare/admin/index.php":
				$pageTitle = "Data Share: Admin";
				break;
			case "/plugins/datashare/admin/add.php":
				$pageTitle = "Data Share: Admin";	
				break;
			case "/plugins/datashare/admin/edit.php":
				$pageTitle = "Data Share: Admin";
				break;
