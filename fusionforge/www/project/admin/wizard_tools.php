...
if (getStringFromRequest('submit')) {
	...
	$form_shortdesc = htmlspecialchars(getStringFromRequest('form_shortdesc'));
	...
	$form_downloaddescription = htmlspecialchars(getStringFromRequest('form_downloaddescription'));
