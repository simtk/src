...
// Replace "appPhpbb.php" with "app.php" for iFrame URL content.
$the_url_self = $_SERVER['PHP_SELF'];
$idxStart = stripos($the_url_self, "/plugins/phpBB/");
if ($idxStart === false) {
	// Not phpBB URL.
	return;
}
$strPhpbbURL = str_replace("/appPhpbb.php/", "/app.php/", $the_url_self);
...
// Encode URL except "/".
// NOTE: Otherwise, e.g. '%' and '/" in the URL will have problems.
$strPhpbbURL = implode(
	'/', 
	array_map(
		function ($v) {
